...
@Service
public class GetAllDesaparecidosUseCase{
    ...
    public GetAllDesaparecidosUseCase(DesaparecidoService desaparecidoService, DesaparecidoMapper desaparecidoMapper) {

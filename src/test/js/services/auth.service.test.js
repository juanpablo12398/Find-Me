...
describe('AuthService', () => {
  describe('checkAuth', () => {
    ...
    it('retorna false y limpia currentUser cuando /me falla', async () => {
      ...
      // No debería haber console.log de éxito
      expect(consoleLogSpy).not.toHaveBeenCalledWith(
        expect.stringMatching(/✅ Sesión activa encontrada/)
      );
    });
  ...
  describe('login', () => {
    it('guarda y devuelve el usuario cuando login es ok', async () => {
      ...
      // Verificar el console.log de login exitoso
    ...
    it('lanza Error con mensaje mapeado cuando login falla', async () => {
      ...
      // No debería haber console.log de éxito
      expect(consoleLogSpy).not.toHaveBeenCalledWith(
        expect.stringMatching(/✅ Login exitoso/)
      );
    });
  });
  ...
  describe('logout', () => {
    it('hace POST a /logout, limpia el usuario y loguea éxito', async () => {
      ...
      // Verificar el console.log de logout exitoso
  ...
  describe('getCurrentUser', () => {
    ...
    it('retorna el usuario actual si hay sesión', () => {
  ...
  describe('isAuthenticated', () => {
    it('retorna false cuando currentUser es null', () => {
      _currentUser = null;
      expect(AuthService.isAuthenticated()).toBe(false);
    });

    it('retorna true cuando hay un usuario actual', () => {
      _currentUser = { id: 4, name: 'María' };
      expect(AuthService.isAuthenticated()).toBe(true);
    });

    it('cambia dinámicamente según el estado de currentUser', () => {
  ...
  describe('Integración checkAuth + isAuthenticated', () => {
    it('isAuthenticated retorna true después de checkAuth exitoso', async () => {
    ...
    it('isAuthenticated retorna false después de checkAuth fallido', async () => {
      fetchWithAuthMock.mockResolvedValueOnce(errorResponse(401));
  ...
  describe('Integración login + isAuthenticated', () => {
    it('isAuthenticated retorna true después de login exitoso', async () => {
  ...
  describe('Integración logout + isAuthenticated', () => {
    it('isAuthenticated retorna false después de logout', async () => {
